...
var tests = []struct {
	...
	{"ObjC-Testpkg", "objc", "github.com/thommil/tge-mobile/bind/testdata/testpkg", ""},
	{"Java-Testpkg", "java", "github.com/thommil/tge-mobile/bind/testdata/testpkg", ""},
	{"Go-Testpkg", "go", "github.com/thommil/tge-mobile/bind/testdata/testpkg", ""},
	{"Java-Javapkg", "java", "github.com/thommil/tge-mobile/bind/testdata/testpkg/javapkg", "android"},
	{"Go-Javapkg", "go", "github.com/thommil/tge-mobile/bind/testdata/testpkg/javapkg", "android"},
	{"Go-Javapkg", "go,java,objc", "github.com/thommil/tge-mobile/bind/testdata/cgopkg", "android"},
}

func installGobind() error {
	if out, err := exec.Command("go", "install", "github.com/thommil/tge-mobile/cmd/gobind").CombinedOutput(); err != nil {
