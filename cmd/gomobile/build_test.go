...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/thommil/tge-mobile/example/basic"})
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/thommil/tge-mobile", "github.com/thommil/tge-mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/thommil/tge-mobile", "github.com/thommil/tge-mobile", 2},
		{"ffffffff t github.com/example/github.com/thommil/tge-mobile", "", 0},
